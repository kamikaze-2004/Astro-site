        ...
        <div className="px-6 py-10">
          <div className=" mt-20 lg:mt-44 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 items-center mb-8">
            <div className="flex flex-col justify-start items-center md:items-start lg:items-start">
              <TypingText classN={'text-6xl mb-2 font-bold'} text={'AstroClub'} speed={0.01}/>
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col justify-start items-center md:items-start lg:items-start">
              <TypingText classN={'text-6xl mb-2 font-bold'} text={'Our Vision'} speed={0.01}/>
              <TypingText classN={'text-xl font-semibold mt-2 mb-4'} text={'To inspire humanity – in Science and Astronomy.'} speed={0.02}/>
              <TypingText
                text={
