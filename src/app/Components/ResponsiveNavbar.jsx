  ...
  return (
    <>
      <div className={`fixed border border-transparent z-[5001] top-2 left-1 lg:left-5 lg:top-12`}>
        <button className={`block py-1 px-3 border-2 bg-gray-900 text-current rounded-3xl hover:bg-black/5 dark:hover:bg-white/5 ${isOpen? 'border-red-400': 'border-lime-400'}`} onClick={togglenav}>
          {isOpen ? "X" : "☴"}
        </button>
      </div>
